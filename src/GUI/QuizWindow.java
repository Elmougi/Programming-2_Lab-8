...
public class QuizWindow extends JDialog {
    ...
    private void highlightCorrectAnswers(List<Integer> userAnswers) {
        ...
        for (int i = 0; i < questions.size(); i++) {
            ...
            buttons[correctIndex].setForeground(new Color(0, 128, 0));
            buttons[correctIndex].setFont(new Font("Arial", Font.BOLD, 12));

            if (userAnswerIndex != correctIndex) {
                buttons[userAnswerIndex].setForeground(Color.RED);
            }
        }
    }
}